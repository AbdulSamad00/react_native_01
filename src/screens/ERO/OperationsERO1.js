...
const validationSchema = Yup.object().shape({
  ...
  primInsuranceValidTill: Yup.date()
    .optional()
    .label("Prim.Insurance Valid Till")
    .nullable(),
  ...
  secInsuranceValidTill: Yup.date()
    .optional()
    .label("Sec. Insurance Valid Till")
    .nullable(),
...
export function OperationsERO({ route, navigation, errors: E }) {
  ...
  const eroApi = useApi(erosApi.addero);
  ...
  useEffect(() => {
    if (route.params) {
      ...
      console.log(route.params.selectedERO.id);
    }
                  ...
                  >
                    ...
                    <FormPicker
                     style={{width: 250, marginVertical: 18}}
                      ...
                      data={["Male", "Female", "Other"].map((gender) => ({
                        label: gender,
                        value: gender,
                      }))}
                      mode="flat"
