...
import { Navbar, Appbtn } from "../../components";
...
const validationSchema = Yup.object().shape({
  prefix: Yup.string().required().label("Required"),
  firstName: Yup.string().required().label("First Name"),
  initials: Yup.string().optional().label("initials"),
  lastName: Yup.string().required().label("Last Name"),
  username: Yup.string().required().min(3).label("username"),
  prefix: Yup.string().optional().min(3).label("prefix"),
  password: Yup.string().min(4).required("Password"),
  ...
  primInsuranceValidTill: Yup.date()
    .optional()
    .label("primInsuranceValidTill")
    .nullable(),
  secInsuranceValidTill: Yup.date()
    .optional()
    .label("secInsuranceValidTill")
    .nullable(),
  idPaperValidTill: Yup.date()
    .optional()
    .label("ID Paper Valid Till")
    .nullable(),
  secInsuranceNo: Yup.string().optional().label("Sec. Insurance-No"),
  secInsurance: Yup.string().optional().label("secInsurance"),
            ...
            <View style={styles.TextinputFields}>
              <Form
                initialValues={{
                  ...
                  secInsuranceValidTill: secInsuranceValidTill
                    ? secInsuranceValidTill
                    : "",
                  primInsuranceValidTill: primInsuranceValidTill
                    ? primInsuranceValidTill
                    : "",
              ...
              >
                ...
                <View>
                  ...
                  >
                    ...
                    <Text style={{ marginVartical: 5 }}>Date of Birth:</Text>
