...
export class AppoinmentsDetail extends Component {
  state = {
    data: [
      {
        name: "Dr. John Doe",
          ...
          <View style={styles.TopContainer}>
            <View style={styles.ContainerForPic}>
              ...
              <View style={styles.TopMiddleContianer}>
                <Text style={styles.nameText}>Appointment Detail</Text>
              </View>
            </View>
          </View>
          {/* header */}
          ...
          <View style={styles.flatlistContainer}>
            <View style={styles.FlatListTopView}>
              <View style={styles.ItemContainer}>
                <Text style={styles.itemAppoinment}>As Consultant</Text>
              </View>
            </View>
            ...
            <View style={styles.FlatListMiddleView}>
              ...
              <View style={styles.FlatlistMiddleMiddle}>
                ...
                <Text style={styles.ItemSpecilist}>New Delhi</Text>
              </View>
            </View>
            <View style={styles.DocDetails}>
            ...
            <View style={styles.DocDetails}>
              <Text style={styles.DocText}>Schedule</Text>
            </View>
            <View style={styles.DetailsContainer2}>
              <Text style={styles.DocTextabc}>
                15 Aug 2020, 10:30 AM - 11:00 AM
              </Text>
            </View>
          ...
          <View style={styles.flatlistContainer4}>
            <View style={styles.FlatListTopView}>
              <View style={styles.ItemContainer2}>
                <Text style={styles.itemAppoinment}>PAID</Text>
              </View>
            </View>
            <View style={styles.DocDetails}>
            ...
            <View style={styles.DetailsContainer3}>
              ...
              <View style={[styles.paymentSlip, { paddingRight: h("2%") }]}>
                ...
                <Text style={styles.PaymentChild}>Credit Card</Text>
              </View>
              <View style={styles.paymentSlip}>
