...
const option = ['Active', 'Banned', 'Pending','Archived'];
const StatusUser = () => {
    ...
    return (
        <View style={styles.Topmargin}>
            <View style={styles.HeaderText}>
                <Text style={styles.HeaderTextf}>StatusUser</Text>
            </View>
            ...
            <View style={styles.container}>
                ...
                {/* <ModalDropdown
                    ...
                    defaultValue={'Select StatusUser'}
                    options={option} /> */}
                <View style={{}}>
                    <Picker
                        style={{ width: 250, backgroundColor: StatusUser, marginLeft: 50, marginTop: -35 }}
                    ...
                    >
                        ...
                        <Picker.Item color="black" label="Banned" value="red" />
