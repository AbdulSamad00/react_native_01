...
const option = ['Active','Re-open','Locked','Banned','Archived','Pending','Invoiced','Paid','Refund','New'];
const Status = () => {
            ...
            <View style={styles.container}>
                ...
                <View style={{}}>
                    ...
                    >
                        ...
                        <Picker.Item color="black" label="Active" value="blue" />
                        ...
                        <Picker.Item color="black" label="Invoiced" value="blue" />
                        <Picker.Item color="black" label="Paid" value="pink" />
                        <Picker.Item color="black" label="Refund" value="red" />
                        <Picker.Item color="black" label="New" value="red" />						
                    </Picker>
                </View>
            </View>
        </View >
